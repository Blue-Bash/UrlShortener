package urlshortener.demo.websockets;
...
public class LiveStatsHandler extends TextWebSocketHandler {
    private static final Logger LOGGER = Grizzly.logger(LiveStatsHandler.class);
